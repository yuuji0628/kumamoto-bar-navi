...
// v2.97: dedicated modern-format header logo.
const KBN_LOGO_192_WEBP_B64="";
function kbnLogo192WebpBytesV297(){
  const raw=atob(KBN_LOGO_192_WEBP_B64);
  const out=new Uint8Array(raw.length);
  for(let i=0;i<raw.length;i++)out[i]=raw.charCodeAt(i);
  return out;
}
...
function kbnHomeTypographyStyleV472(){
  return `<style id="kbn-home-typography-v477">
  ...
  body.public-v109 main h1 .kbn-hero-line1-v474{display:block!important;color:#f7f7f5!important;font-family:inherit!important;font-size:.55em!important;font-weight:600!important;letter-spacing:-.018em!important;line-height:1.2!important;margin:0 0 .25em!important}
  body.public-v109 main h1 .kbn-hero-bar-v476{color:#D4AF37!important;font-weight:750!important;letter-spacing:-.025em!important}
  body.public-v109 main h1 .kbn-hero-line2-v474{display:block!important;color:#D4AF37!important;font-family:inherit!important;font-size:1em!important;font-weight:850!important;letter-spacing:-.055em!important;line-height:1.04!important}
  ...
  @media(max-width:640px){
    body.public-v109 main h1{font-size:clamp(2.25rem,9.9vw,2.82rem)!important;line-height:1.06!important;letter-spacing:-.04em!important}
    body.public-v109 main h1 .kbn-hero-line1-v474{font-size:.55em!important;letter-spacing:-.018em!important;margin-bottom:.25em!important;font-weight:600!important}
...
async function kbnEnsureMinuteCronPermanentV230(env){
  ...
  try{
    ...
    if(current.length!==1||String(current[0]).trim()!==fixed[0]){
      ...
      config.vars=config.vars&&typeof config.vars==="object"?config.vars:{};
      config.vars.KBN_CONFIG_VERSION="4.77";
      const content=JSON.stringify(config,null,2)+"\n";
...
async function renderLocalSeoAreaGenrePage(env,areaSlug,genreSlug){
  ...
  const cards=shops.map(s=>{
    ...
    const budget=kbnBudget(s);
    const features=String(s.features||"").split(/[、,／/・|]/).map(x=>x.trim()).filter(Boolean).slice(0,3);
    return `<article class="local-seo-card"><a href="/shop?slug=${encodeURIComponent(s.slug||"")}"><div class="local-seo-img">${s.image_url?`<img src="${kbnSeoEsc(s.image_url)}" alt="${kbnSeoEsc(name)}｜${kbnSeoEsc(area)}の${kbnSeoEsc(label)}" loading="lazy" decoding="async" fetchpriority="low">`:`<img src="/default-bar.svg" alt="" loading="lazy" decoding="async" fetchpriority="low">`}</div><div class="local-seo-body"><div class="local-seo-meta"><span>${kbnSeoEsc(area)}</span><span>${kbnSeoEsc(s.genre||label)}</span></div><h2>${kbnSeoEsc(name)}</h2>${s.address?`<p>${kbnSeoEsc(s.address)}</p>`:""}${features.length?`<div class="kbn-area-tags">${features.map(f=>`<span>${kbnSeoEsc(f)}</span>`).join("")}</div>`:""}<div class="local-seo-facts">${s.hours?`<span><small>営業時間</small><b>${kbnSeoEsc(s.hours)}</b></span>`:""}${budget?`<span><small>料金目安</small><b>${kbnSeoEsc(budget)}</b></span>`:""}</div>${kbnPublicUpdatedDateV458(s.updated_at)?`<small style="display:block;margin-top:8px;color:#7d8993;font-size:.68rem">情報更新 ${kbnSeoEsc(kbnPublicUpdatedDateV458(s.updated_at))}</small>`:""}<div class="local-seo-bottom">${Number(s.is_recruiting||0)===1?"<em>求人あり</em>":""}<b>店舗詳細を見る →</b></div></div></a></article>`;
  }).join("");
...
function kbnPublicUpdatedDateV458(v){
...
async function renderAllShopsSeoIndexV250(env,origin){
  ...
  const sections=[...groups.entries()].map(([area,list])=>{
    ...
    return `<section><h2>${kbnSeoEsc(area)}${areaLink}</h2><ul>${list.map(x=>`<li><a href="/shop?slug=${encodeURIComponent(x.slug||"")}">${kbnSeoEsc(kbnCleanShopName(x.name)||"BAR")}</a>${x.genre?` <small>${kbnSeoEsc(x.genre)}</small>`:""}${kbnPublicUpdatedDateV458(x.updated_at)?` <small style="opacity:.55;font-size:.72em">情報更新 ${kbnSeoEsc(kbnPublicUpdatedDateV458(x.updated_at))}</small>`:""}</li>`).join("")}</ul></section>`;
  }).join("");
...
async function ensureInfoEnrichQueueV402(env){
  await env.DB.prepare(`
    CREATE TABLE IF NOT EXISTS kbn_info_enrich_queue(
      shop_id INTEGER PRIMARY KEY,
      status TEXT NOT NULL DEFAULT 'unseen',
      error_count INTEGER NOT NULL DEFAULT 0,
      last_reason TEXT DEFAULT '',
      last_match_score REAL NOT NULL DEFAULT 0,
      official_site_found INTEGER NOT NULL DEFAULT 0,
      instagram_verified INTEGER NOT NULL DEFAULT 0,
...
async function saveInfoEnrichQueueV402(env,shopId,{status='checked',reason='',matchScore=0,officialSiteFound=false,instagramVerified=false,errorIncrement=false,retryHours=0,retryDays=0}={}){
  await ensureInfoEnrichQueueV402(env);
  const current=await env.DB.prepare(`SELECT error_count FROM kbn_info_enrich_queue WHERE shop_id=? LIMIT 1`).bind(shopId).first();
  const errors=errorIncrement?Number(current?.error_count||0)+1:0;
  let retrySql='NULL';
  let retryBind=[];
  if(retryHours>0){retrySql=`datetime('now','+' || ? || ' hours')`;retryBind=[Math.round(retryHours)];}
  else if(retryDays>0){retrySql=`datetime('now','+' || ? || ' days')`;retryBind=[Math.round(retryDays)];}
  const sql=`
    INSERT INTO kbn_info_enrich_queue(shop_id,status,error_count,last_reason,last_match_score,official_site_found,instagram_verified,next_retry_at,last_checked_at,updated_at)
    VALUES(?,?,?,?,?,?,?,${retrySql},CURRENT_TIMESTAMP,CURRENT_TIMESTAMP)
    ON CONFLICT(shop_id) DO UPDATE SET
      status=excluded.status,error_count=excluded.error_count,last_reason=excluded.last_reason,
      last_match_score=excluded.last_match_score,official_site_found=excluded.official_site_found,
      instagram_verified=excluded.instagram_verified,next_retry_at=excluded.next_retry_at,
      last_checked_at=CURRENT_TIMESTAMP,updated_at=CURRENT_TIMESTAMP
  `;
  await env.DB.prepare(sql).bind(shopId,status,errors,String(reason||'').slice(0,220),Number(matchScore||0),officialSiteFound?1:0,instagramVerified?1:0,...retryBind).run();
  return {error_count:errors};
}

async function infoEnrichQueueStatsV402(env){
  await ensureInfoEnrichQueueV402(env);
  const row=await env.DB.prepare(`
    SELECT
      COUNT(*) AS known,
      SUM(CASE WHEN status='search_error' AND next_retry_at>datetime('now') THEN 1 ELSE 0 END) AS cooldown,
      SUM(CASE WHEN status='matched_no_new_data' THEN 1 ELSE 0 END) AS no_new,
      SUM(CASE WHEN status='no_candidate' THEN 1 ELSE 0 END) AS no_candidate,
      SUM(CASE WHEN status='match_below_threshold' THEN 1 ELSE 0 END) AS below,
      SUM(CASE WHEN status='updated' THEN 1 ELSE 0 END) AS updated
    FROM kbn_info_enrich_queue
  `).first();
...
async function infoEnrichDailySummaryV404(env){
  ...
  const rows=await env.DB.prepare(`
    ...
    ORDER BY id ASC
  `).all();
  const out={runs:0,manual_runs:0,maintenance_runs:0,auto_recheck_runs:0,checked:0,updated:0,score_gain:0,fields:{hours:0,address:0,phone:0,instagram:0,holiday:0,image:0,budget:0,features:0},reasons:{search_error:0,cache_hit_search:0,cache_hit_details:0},last_run_at:''};
  for(const r of (rows.results||[])){
    out.runs++;
    const src=String(r.source||'');
    if(src==='maintenance')out.maintenance_runs++;
    else if(src==='auto_recheck')out.auto_recheck_runs++;
    else out.manual_runs++;
...
async function infoEnrichAutoRecheckStatusV405(env){
  await ensureInfoEnrichQueueV402(env);
  const row=await env.DB.prepare(`
    SELECT
      COUNT(*) AS total_candidates,
      SUM(CASE WHEN q.shop_id IS NULL OR q.next_retry_at IS NULL OR q.next_retry_at<=datetime('now') THEN 1 ELSE 0 END) AS eligible_now,
      MIN(CASE WHEN q.next_retry_at>datetime('now') THEN q.next_retry_at ELSE NULL END) AS next_retry_at
    FROM shops s
    LEFT JOIN kbn_info_enrich_queue q ON q.shop_id=s.id
    WHERE COALESCE(s.is_published,1)=1 AND (${KBN_SEO_SCORE_SQL_V312})<90
      AND (
  ...
  const last=await env.DB.prepare(`
    SELECT checked,updated,score_gain,created_at FROM kbn_info_enrich_runs
    WHERE source='auto_recheck' ORDER BY id DESC LIMIT 1
  `).first().catch(()=>null);
  return {
    total_candidates:Number(row?.total_candidates||0),
    eligible_now:Number(row?.eligible_now||0),
    next_retry_at:String(row?.next_retry_at||''),
    last_auto_recheck:last||null,
    automatic:true,
    cadence:'scheduled_auto_slots'
  };
}
...
async function enrichPriorityPublishedInfoV401(env,{targetUpdated=20,maxChecked=80}={}){
  ...
  const r=await env.DB.prepare(`
    SELECT s.id,s.name,s.slug,s.area,s.address,s.hours,s.holiday,s.instagram,s.genre,s.features,s.description,
           s.phone,s.image_url,s.image_key,s.budget_min,s.budget_max,s.seats,(${KBN_SEO_SCORE_SQL_V312}) AS seo_score,
           q.status AS queue_status,q.error_count AS queue_error_count,q.last_match_score AS queue_match_score
    FROM shops s
    LEFT JOIN kbn_info_enrich_queue q ON q.shop_id=s.id
    WHERE COALESCE(s.is_published,1)=1 AND (${KBN_SEO_SCORE_SQL_V312})<90
      AND (
      ...
      AND (q.shop_id IS NULL OR q.next_retry_at IS NULL OR q.next_retry_at<=datetime('now'))
    ORDER BY
      CASE
        WHEN q.shop_id IS NULL THEN 0
        WHEN q.status='search_error' THEN 1
        WHEN q.status='match_below_threshold' THEN 2
        WHEN q.status='no_candidate' THEN 3
        WHEN q.status='matched_no_new_data' THEN 4
        ELSE 5
      END ASC,
      COALESCE(q.last_match_score,0) DESC,
      (${KBN_SEO_SCORE_SQL_V312}) ASC,
      s.id ASC
    LIMIT ?
  `).bind(cap).all();
  const rows=r.results||[];
  ...
  for(const shop of rows){
    ...
    try{
      ...
      if(!found?.ok){
        ...
        const retryHours=kbnRetryHoursV402(priorErrors);
      ...
      if(!found?.matched){
        ...
        if(sc>0){
          reason_counts.match_below_threshold++;
          await saveInfoEnrichQueueV402(env,shop.id,{status:'match_below_threshold',reason:'MATCH_BELOW_THRESHOLD',matchScore:sc,retryDays:7});
        }else{
          reason_counts.no_candidate++;
          await saveInfoEnrichQueueV402(env,shop.id,{status:'no_candidate',reason:'GOOGLE_MATCH_NOT_FOUND',matchScore:0,retryDays:14});
        }
      ...
      if(!fields.length){
        ...
        await saveInfoEnrichQueueV402(env,shop.id,{status:'matched_no_new_data',reason:'MATCHED_BUT_NO_NEW_VERIFIED_DATA',matchScore:Number(found?.score||0),officialSiteFound:!!website,instagramVerified:igVerified,retryDays:30});
      ...
      await saveInfoEnrichQueueV402(env,shop.id,{status:'updated',reason:'UPDATED_VERIFIED_DATA',matchScore:Number(found?.score||0),officialSiteFound:!!website,instagramVerified:igVerified,retryDays:30});
      for(const f of item.fields)if(f in field_counts)field_counts[f]++;
    }catch(e){
      reason_counts.failed++;
      await saveInfoEnrichQueueV402(env,shop.id,{status:'failed',reason:String(e?.message||e).slice(0,200),errorIncrement:true,retryHours:12}).catch(()=>{});
      failed.push({id:shop.id,name:shop.name,reason:String(e?.message||e).slice(0,250)});
    }
  }
...
async function kbnQueueAutoInfoRecheckV405(env,runDate=''){
  ...
  await env.DB.prepare(`
    ...
    VALUES(1,9,?,0,CURRENT_TIMESTAMP)
...
async function ensureKbnDailyPrecisionV433(env){
  ...
  try{
    const info=await env.DB.prepare("PRAGMA table_info(kbn_daily_precision_state)").all();
    const names=new Set((info.results||[]).map(x=>String(x.name||"")));
...
async function kbnProcessDailyPrecisionV433(env){
  ...
  if(stage==='closed'){
    // v4.39: Google Placesがクォータ/権限/課金等で停止中なら、
    // 閉業確認を何時間も失敗させず、その日の処理は保留してInstagramへ進む。
...
async function kbnProcessQueuedMaintenanceV242(env){
  ...
  if(phase>=11 && phase<=49){
    ...
    try{googleHealthAtStart=await kbnGooglePlacesHealthV438(env)}catch{}
    const googleUnavailable=!!googleHealthAtStart?.disabled;
    // Google停止中に代替ソースでも成果0なら20検索で見切る。
    const fallbackZeroCutoff=googleUnavailable && createdTotal===0 && searchedTotal>=20;
    ...
    if(discoverySatisfied){
      ...
      try{
        ...
        if(gh?.disabled)googleStopNote=` / Google停止:${String(gh.error_code||'API_ERROR')}`;
      }catch{}
      await logKbnMaintenanceHistoryV414(env,{
        ...
        note:timeLimitReached
          ?`BAR開拓30分上限で終了 / ${searchedTotal}検索 / 新規${createdTotal}店${googleStopNote} / 次の情報補完へ`
          :`BAR開拓検索上限で終了 / ${searchedTotal}検索 / 新規${createdTotal}店${googleStopNote} / 次の情報補完へ`
      });
      return {
        ...
        cutoff:timeLimitReached?'30min':(fallbackZeroCutoff?'google_unavailable_zero':'search_limit'),
  ...
  try{
    if(task==="verified_info" || task==="verified_auto"){
      ...
      await createKbnAlert(env,{
        type:task==="verified_auto"?"auto_recheck_verified_info":"maintenance_verified_info",
        title:task==="verified_auto"?"自動再確認: VERIFIED情報補完":"自動メンテナンス: VERIFIED情報補完",
        message:`${checked}店舗を確認 / ${updated}店舗を更新 / SEO +${Number(result?.score_gain_total||0)}点 / クールダウン切れ・未確認候補のみ自動処理`
      });
...
export default {
  async fetch(request, env, ctx) {
    ...
    if(request.method==="GET" && url.pathname==="/logo-192.webp"){
      const bytes=kbnLogo192WebpBytesV297();
      return new Response(bytes,{headers:{
        "Content-Type":"image/webp",
        "Cache-Control":"public, max-age=31536000, immutable",
        "Content-Length":String(bytes.byteLength),
        "X-KBN-Asset":"logo-192-webp-v297"
      }});
    }
...
<sitemapindex xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  ...
  <sitemap><loc>${base}/sitemap-shops.xml</loc><lastmod>${now}</lastmod></sitemap>
    ...
    if(url.pathname.startsWith("/api/admin/") && !["/api/admin/login","/api/admin/logout","/api/admin/status"].includes(url.pathname)){
      ...
      // ---------- Automatic cooldown recheck status v4.05 ----------
      if(url.pathname==="/api/admin/info-enrich-auto-status" && request.method==="GET"){
        const status=await infoEnrichAutoRecheckStatusV405(env);
    ...
    if(request.method==="GET" && url.pathname==="/" && env.DB){
      try{
        ...
        if(assetResponse.ok){
          ...
          html=html.replace('</head>',kbnHomeTypographyStyleV472()+'</head>');
